...
public class StudySearchRequest extends SearchRequest {
	...
	private static final Map<String, EntityColumnNameAndType> ALLOWED_SORT_AND_FILTER_FIELDS =
			Map.ofEntries(
					...
					Map.entry("programDbId", new EntityColumnNameAndType("program.id", EntityType.UUID)),
					Map.entry("programName", new EntityColumnNameAndType("program.name", EntityType.TEXT)),
